...
# save path
    ...
    test_imgs_save_path = "test_imgs_saved/" + str(exp_id) + "_" + exp_desc
    save_test_img = True

# datasets
    train_data_list = "/home/snk/WindowsDisk/Download/KITTI/cmpr_datasets/traintest.txt" if not GPU_HPC else "/share/Dataset/KITTI/traintest.txt"
    val_data_list = "/home/snk/WindowsDisk/Download/KITTI/cmpr_datasets/val_subset.txt" if not GPU_HPC else "/share/Dataset/KITTI/val.txt"
    test_data_list = "/home/snk/WindowsDisk/Download/KITTI/cmpr_datasets/test_subset.txt" if not GPU_HPC else "TODO"
# training
