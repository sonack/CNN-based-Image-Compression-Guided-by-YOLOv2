...
class ResNet(nn.Module):
    ...
    def __init__(self, model_name, block, layers, num_classes=1000):
...
def resnet18(pretrained=False, **kwargs):
    ...
    """
    model = ResNet("ResNet18_Official", BasicBlock, [2, 2, 2, 2], **kwargs)
    if pretrained:
...
def resnet34(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet("ResNet34_Official", BasicBlock, [3, 4, 6, 3], **kwargs)
    if pretrained:
...
def resnet50(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet("ResNet50_Official", Bottleneck, [3, 4, 6, 3], **kwargs)
    if pretrained:
...
def resnet101(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet("ResNet101_Official", Bottleneck, [3, 4, 23, 3], **kwargs)
    if pretrained:
...
def resnet152(pretrained=False, **kwargs):
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet("ResNet152_Official", Bottleneck, [3, 8, 36, 3], **kwargs)
    if pretrained:
